...
export type View = 'journal' | 'stats' | 'ai' | 'tags' | 'about' | 'admin';
  ...
  return (
    <nav className="sidenav">
      ...
      <div className="sidenav__items">
        ...
        <button
          className={`sidenav__item ${currentView === 'tags' ? 'sidenav__item--active' : ''}`}
        ...
        >
          ...
          <span className="sidenav__label">Tags</span>
        </button>
